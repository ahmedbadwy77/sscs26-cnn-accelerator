...
# Usage (from demo/sim):  vsim -c -do run_sobel_gx_relu.do
transcript on
...
vsim -voptargs=+acc -gRELU_EN=1 work.tb_sobel_demo +kernel=kernel_gx.hex +expected=../expected/expected_sobel_gx_relu.txt
run -all
