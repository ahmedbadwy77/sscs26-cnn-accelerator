...
# Usage (from demo/sim):  vsim -c -do run_sobel_gy_relu.do
transcript on
...
vsim -voptargs=+acc -gRELU_EN=1 work.tb_sobel_demo +kernel=kernel_gy.hex +expected=../expected/expected_sobel_gy_relu.txt
run -all
