# Sobel Gy regression (RELU=0) - 900 outputs checked against the Python golden file.
# Usage:  vsim -c -do run_sobel_gy.do      (or from the GUI:  do run_sobel_gy.do)
transcript on
...
vsim -voptargs=+acc -gRELU_EN=0 work.tb_sobel_demo +kernel=kernel_gy.hex +expected=expected_sobel_gy.txt
run -all
