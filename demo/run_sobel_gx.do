...
# Usage:  vsim -c -do run_sobel_gx.do      (or from the GUI:  do run_sobel_gx.do)
transcript on
...
vsim -voptargs=+acc -gRELU_EN=0 work.tb_sobel_demo +kernel=kernel_gx.hex +expected=expected_sobel_gx.txt
run -all
