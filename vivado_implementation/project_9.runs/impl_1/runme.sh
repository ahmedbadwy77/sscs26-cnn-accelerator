...
HD_PWD='/mnt/hgfs/Digital_Shared_Folder/Best_design_v2_compare/LAST_VERISON/project_9/project_9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cnn_top.tcl -notrace
