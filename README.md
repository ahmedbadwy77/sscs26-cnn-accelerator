...
- **Tool versions:** All implementation results reported here and in the report PDF were produced with the **Vivado 2019.1** toolchain for the submission build (the shipped run reports are headed *Vivado v.2019.1*, Build 2552052). Simulation used **ModelSim – Intel FPGA Edition 2020.1**.
